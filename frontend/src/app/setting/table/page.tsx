                ...
                <TableBody>
                  {tables.map((table) => (
                    <TableRow key={table.id}>
                      ...
                      <TableCell>
                        <Box
                          sx={{
                            ...
                            backgroundColor: 
                              table.status === 'available' ? '#e8f5e8' :
                              table.status === 'playing' ? '#fff3e0' : '#ffebee',
                            color: 
                              table.status === 'available' ? '#2e7d32' :
                              table.status === 'playing' ? '#f57c00' : '#c62828',
                          }}
                        >
                      ...
                      <TableCell>{parseFloat(table.price_per_hour.toString()).toLocaleString('vi-VN')}</TableCell>
                      <TableCell>{new Date(table.created_at).toLocaleDateString('vi-VN')}</TableCell>
                      <TableCell>
