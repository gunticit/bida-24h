...
export default function NotFound() {
  ...
  return (
    ...
    >
      <Typography variant="h3" sx={{ fontWeight: 'bold' }}>Trang tìm kiếm không tồn tại</Typography>
      <Box>
        <DotLottieReact
      ...
      <Button onClick={handleBackHome} variant="outlined" sx={{mt: 2}}>Bảng điều khiển</Button>
    </Box>
  )
}